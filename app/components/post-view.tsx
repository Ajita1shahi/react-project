        ...
        <div className="flex flex-col gap-5">
            ...
            <div>
                <form
                    ...
                    <textarea
                        name="content"
                        className="w-full h-20 border border-amber-200 text-black rounded-md p-2"
                        placeholder="Enter Comment"
                    ></textarea>
                    <button
                        type="submit"
                        className="bg-amber-200 text-black px-7 py-2 text-sm rounded-md">
                        Comment
                    </button>
                </form>
            </div>
            ...
            <div className="flex flex-col gap-5">
                {comments.map(comment => (
                    <div key={comment.id} className="flex flex-col gap-3 bg-amber-200/10 p-5 rounded-md">
